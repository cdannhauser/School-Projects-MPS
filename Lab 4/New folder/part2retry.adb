...
F:G$loop$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$ADC_ISR$0$0({2}DF,SV:S),Z,0,0,1,15,0
...
T:Fpart2retry$tm[({0}S:S$tm_sec$0$0({1}SC:U),Z,0,0)({1}S:S$tm_min$0$0({1}SC:U),Z,0,0)({2}S:S$tm_hour$0$0({1}SC:U),Z,0,0)({3}S:S$tm_mday$0$0({1}SC:U),Z,0,0)({4}S:S$tm_mon$0$0({1}SC:U),Z,0,0)({5}S:S$tm_year$0$0({2}SI:S),Z,0,0)({7}S:S$tm_wday$0$0({1}SC:U),Z,0,0)({8}S:S$tm_yday$0$0({2}SI:S),Z,0,0)({10}S:S$tm_isdst$0$0({1}SC:U),Z,0,0)({11}S:S$tm_hundredth$0$0({1}SC:U),Z,0,0)]
S:Lpart2retry.getchar$c$1$23({1}SC:U),R,0,0,[]
S:G$vH$0$0({3}DG,SC:U),E,0,0
S:G$vL$0$0({3}DG,SC:U),E,0,0
S:G$voltage$0$0({2}SI:S),E,0,0
S:G$previousVoltage$0$0({2}SI:S),E,0,0
S:G$average$0$0({4}SL:S),E,0,0
S:G$max$0$0({2}SI:S),E,0,0
S:G$min$0$0({2}SI:S),E,0,0
S:G$TR0_count$0$0({2}SI:U),E,0,0
S:G$sampleCount$0$0({2}SI:U),E,0,0
S:G$frequency$0$0({2}SI:U),E,0,0
S:Lpart2retry.loop$vActual$1$36({4}SF:S),E,0,0
S:Lpart2retry.loop$i$1$36({1}SC:U),R,0,0,[r3]
S:Lpart2retry.main$restart$1$33({1}SB0$1:U),R,0,0,[]
...
S:Fpart2retry$__str_0$0$0({8}DA8d,SC:S),D,0,0
S:Fpart2retry$__str_1$0$0({19}DA19d,SC:S),D,0,0
S:Fpart2retry$__str_2$0$0({15}DA15d,SC:S),D,0,0
S:Fpart2retry$__str_3$0$0({13}DA13d,SC:S),D,0,0
S:Fpart2retry$__str_4$0$0({3}DA3d,SC:S),D,0,0
S:Fpart2retry$__str_5$0$0({3}DA3d,SC:S),D,0,0
S:Fpart2retry$__str_6$0$0({13}DA13d,SC:S),D,0,0
S:Fpart2retry$__str_7$0$0({13}DA13d,SC:S),D,0,0
S:Fpart2retry$__str_8$0$0({16}DA16d,SC:S),D,0,0
