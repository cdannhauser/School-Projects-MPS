...
S:Lmain.getchar$c$1$24({1}SC:S),R,0,0,[]
S:G$vH$0$0({3}DG,SC:S),E,0,0
S:G$vL$0$0({3}DG,SC:S),E,0,0
...
S:Lmain.loop$vActual$1$37({4}SF:S),E,0,0
S:Lmain.loop$i$1$37({1}SC:S),R,0,0,[r3]
S:Lmain.main$restart$1$34({1}SB0$1:U),R,0,0,[]
...
S:Fmain$__str_0$0$0({8}DA8d,SC:S),D,0,0
S:Fmain$__str_1$0$0({19}DA19d,SC:S),D,0,0
S:Fmain$__str_2$0$0({13}DA13d,SC:S),D,0,0
S:Fmain$__str_3$0$0({3}DA3d,SC:S),D,0,0
S:Fmain$__str_4$0$0({3}DA3d,SC:S),D,0,0
S:Fmain$__str_5$0$0({13}DA13d,SC:S),D,0,0
S:Fmain$__str_6$0$0({13}DA13d,SC:S),D,0,0
S:Fmain$__str_7$0$0({16}DA16d,SC:S),D,0,0
