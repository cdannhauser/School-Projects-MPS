...
F:G$ADC_ISR$0$0({2}DF,SV:S),C,0,0,1,15,0
...
S:G$voltages$0$0({32}DA16d,SI:U),E,0,0
S:G$index$0$0({1}SC:U),E,0,0
S:G$average$0$0({2}SI:U),E,0,0
S:Lmain.main$i$1$32({1}SC:S),R,0,0,[]
S:Lmain.ADC_ISR$vActual$1$38({4}SF:S),E,0,0
S:Lmain.ADC_ISR$i$1$38({1}SC:S),R,0,0,[r7]
S:Lmain.main$restart$1$32({1}SB0$1:U),R,0,0,[]
...
S:Fmain$__str_2$0$0({5}DA5d,SC:S),D,0,0
S:Fmain$__str_3$0$0({18}DA18d,SC:S),D,0,0
S:Fmain$__str_4$0$0({18}DA18d,SC:S),D,0,0
S:Fmain$__str_5$0$0({18}DA18d,SC:S),D,0,0
S:Fmain$__str_6$0$0({15}DA15d,SC:S),D,0,0
S:Fmain$__str_7$0$0({3}DA3d,SC:S),D,0,0
