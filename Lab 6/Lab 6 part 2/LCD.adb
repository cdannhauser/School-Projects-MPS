...
S:LLCD.lcd_init$SFRPAGE_SAVE$1$14({1}SC:S),R,0,0,[r7]
S:LLCD.lcd_busy_wait$SFRPAGE_SAVE$1$16({1}SC:S),R,0,0,[r7]
S:LLCD.lcd_dat$dat$1$18({1}SC:S),R,0,0,[r7]
S:LLCD.lcd_dat$SFRPAGE_SAVE$1$19({1}SC:S),R,0,0,[r6]
S:LLCD.lcd_puts$string$1$20({3}DG,SC:S),R,0,0,[r5,r6,r7]
S:LLCD.lcd_puts$i$1$21({2}SI:S),R,0,0,[]
S:LLCD.lcd_cmd$cmd$1$23({1}SC:S),R,0,0,[r7]
S:LLCD.lcd_cmd$SFRPAGE_SAVE$1$24({1}SC:S),R,0,0,[r6]
S:LLCD.lcd_goto$addr$1$27({1}SC:S),R,0,0,[r7]
S:LLCD.large_delay$d$1$35({1}SC:S),R,0,0,[]
S:LLCD.huge_delay$d$1$37({1}SC:S),R,0,0,[]
S:LLCD.lcd_cursor$on$1$31({1}SB0$1:U),H,0,0
