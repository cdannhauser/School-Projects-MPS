...
F:G$map$0$0({2}DF,SI:U),C,0,0,0,0,0
...
F:G$MEM_INIT$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain.getchar$c$1$18({1}SC:S),R,0,0,[]
S:G$count$0$0({1}SC:U),E,0,0
S:Lmain.main$i$1$26({1}SC:S),E,0,0
S:Lmain.loop$i$1$31({2}SI:U),R,0,0,[r6,r7]
S:Lmain.loop$j$1$31({1}SC:U),E,0,0
S:Lmain.loop$parityCount$1$31({1}SC:U),E,0,0
S:Lmain.main$restart$1$26({1}SB0$1:U),R,0,0,[]
S:Lmain.loop$stuff$1$31({10239}DA10239d,SC:U),F,0,0
