...
F:G$sendAndEcho$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$receiveMessage$0$0({2}DF,SC:S),Z,0,0,0,0,0
...
S:Lmain.loop$temp$1$37({1}SC:S),R,0,0,[r7]
S:Lmain.sendAndEcho$temp$1$40({1}SC:S),R,0,0,[r7]
S:Lmain.receiveMessage$temp$1$42({1}SC:U),R,0,0,[r7]
...
S:Fmain$__str_2$0$0({78}DA78d,SC:S),D,0,0
S:Fmain$__str_3$0$0({13}DA13d,SC:S),D,0,0
S:Fmain$__str_4$0$0({10}DA10d,SC:S),D,0,0
